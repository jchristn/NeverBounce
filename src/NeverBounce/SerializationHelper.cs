...
namespace NeverBounce
{
    ...
    internal class SerializationHelper
    {
        ...
        /// <returns>Instance.</returns>
        internal T DeserializeXml<T>(byte[] bytes) where T : class
        {
        ...
        /// <returns>Instance.</returns>
        internal T DeserializeXml<T>(string xml) where T : class
        {
        ...
        internal string SerializeXml(object obj, bool pretty = false)
        {
